...
class FCMService {
    ...
    createNotificationListeners = (onRegister, OnNotification, onOpenNotification) => {
        ...
        messaging()
            .onNotificationOpenedApp(remoteMessage => {
                ...
                if (remoteMessage) {
                    ...
                    // this.removeDeliverdNotification(notification.notification)
                }
            });
        ...
        messaging()
            ...
            .then(remoteMessage => {
                console.log("[FCMService] getInitialNotification Notification caused app to open from quit ", remoteMessage)
                if (remoteMessage) {
                    const notification = remoteMessage.notification
                    onOpenNotification(notification)
